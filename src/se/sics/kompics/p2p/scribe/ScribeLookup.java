...
public class ScribeLookup extends PeerMessage {
	private static final long serialVersionUID = 8493601671018888143L;
	private final BigInteger topicId;

//-------------------------------------------------------------------
	public ScribeLookup(BigInteger topicId, PeerAddress source, PeerAddress destination) {
...
//-------------------------------------------------------------------
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ScribeLookup other = (ScribeLookup) obj;
		if (topicId == null) {
